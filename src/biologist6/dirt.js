...
//               <iframe  width="335px" height="215px" src="https://www.youtube.com/embed/pTjcCtOucYY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
//                 {/* <HeroPage /> */}
//               </div>
//             </Html>
//           </mesh>
        ...
        <group position={[0, 2.96, -0.13]} rotation={[Math.PI / 2, 0, 0]}>
          ...
          <mesh geometry={nodes["Cube008_2"].geometry}>
            ...
            >
              ...
              <iframe  width="334px" height="216px" src="https://www.youtube.com/embed/pTjcCtOucYY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                {/* <HeroPage /> */}
              </div>
            </Html>
          </mesh>
...
export default function App() {
  return (
    <Canvas dpr={[1, 2]} camera={{ position: [-10, 0, -30], fov: 25 }}>
      <pointLight position={[10, 10, 10]} intensity={1.5} />
      <Suspense fallback={null}>
        <group rotation={[0, Math.PI, 0]}>
          <Model />
