...
function Composition({ ...props }) {
  ...
  const [textureRed, textureBlue] = useTexture(['/6fe35b137de0f541c330.png', '/6fe35b137de0f541c330.png'])
...
const M1 = forwardRef(({ texture, children, ...props }, ref) => {
  const { nodes, materials } = useGLTF('/model/mbp-v1-pipe.glb')
  return (
